...
class ZoeController : public controller_interface::ControllerInterface {
  ...
  public:
    ...
    // void OnDriveArcMsg(zoe2_interfaces::msg::DriveArc::SharedPtr driveArc);
    ...
    //     const std::shared_ptr<zoe2_interfaces::srv::DriveCommand::Request>
    //     request, std::shared_ptr<zoe2_interfaces::srv::DriveCommand::Response>
    //     response);
    ...
    private:
        // zoe_motor_hardware::ZoeMotorHardware* zoe_hardware;
